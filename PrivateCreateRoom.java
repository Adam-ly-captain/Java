...
public class PrivateCreateRoom extends JFrame {
    public String Name;
    ...
    private String[] randname = {"a", "b", "c", "d", "e", "f", "g", "h", "i", "j", "k", "l", "m", "n", "o", "p", "q", "r", "s", "t", "u", "v", "w", "x", "y", "z",
            "卢本伟", "孙笑川", "汤老师", "JAVA", "C语言", "高数", "高斯", "柯西", "sun", "oracle", "笑死", "聊天室", "大物", "Trump", "Steve", "终于", "做完了"};

    public PrivateCreateRoom() {
...
//                            System.out.println(name1.getText());
                            Server server = new Server(Name, "多人房间", InetAddress.getLocalHost(), name1.getText(), 2);
